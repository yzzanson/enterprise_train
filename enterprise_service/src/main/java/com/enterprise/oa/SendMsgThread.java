...
public class SendMsgThread implements Runnable {
    ...
    private Logger logger = LoggerFactory.getLogger(SendMsgThread.class);
    ...
    public SendMsgThread(JSONObject msgJsonObject, String content,Integer companyId, String accessToken, JSONObject resultJson, boolean storageFlag) {
