package com.enterprise.mobile.web.session.wrapper;


import com.enterprise.base.common.DDConstant;
import com.enterprise.base.common.SpringContextHolder;
import com.enterprise.service.session.SessionService;
...
//        CookieUtil.removeCookieValue(this.request, this.response, GlobalConstant.JSESSIONID);
        CookieUtil.removeCookieValue(this.request, this.response, DDConstant.COOKIE_NAME_MOBILE);
    }
